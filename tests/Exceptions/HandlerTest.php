...
class HandlerTest extends TestCase
{
    public function testGetMessage(): void
    {
        ...
        $this->assertContains('message', $handler->getMessage(new Error(
            'message',
            100,
            __FILE__,
            __LINE__
        ...
        $this->assertContains(__FILE__, $handler->getMessage(new Error(
            'message',
            100,
            __FILE__,
            __LINE__
        ...
        $this->assertContains('100', $handler->getMessage(new Error(
            'message',
            100,
            __FILE__,
            100
